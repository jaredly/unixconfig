...
hi ErrorMsg term=standout ctermfg=7 ctermbg=1 gui=bold guifg=White guibg=Red
...
hi Comment ctermfg=red term=underline
...
hi pythonMultiString ctermfg=blue
hi pythonString ctermfg=darkgreen
